...
vae = ConvAE(conv_act=conv_act, conv_filt=conv_filt, hidden=hidden)
vae.create_model()
vae.add_loss_funcs()
...
vae.train(data, epochs=400, batch_size=batch_size)
vae.save()

vae_dec = ConvAE_DEC(sigma0, beta, conv_act, conv_filt, hidden)
